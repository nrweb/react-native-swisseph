...
function sweJulday(year, month, day, hour, gregflag) {
  if (!_NativeSwisseph.default) {
    throw new Error('Swisseph native module is not available. Make sure the module is properly linked and you are running on a device/simulator.');
  }
